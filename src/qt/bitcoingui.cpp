...
static QWidget* makeToolBarSpacer()
{
    ...
    spacer->setStyleSheet(fUseBlackTheme ? "QWidget { background: rgb(72,72,72); }" : "QWidget { background: none; }");
    return spacer;
}
...
void BitcoinGUI::createToolBars()
{
    ...
    if (fUseBlackTheme)
    {
        ...
        header->setMinimumSize(170, 170);
        header->setSizePolicy(QSizePolicy::Fixed, QSizePolicy::Fixed);
        header->setStyleSheet("QWidget { background-color: rgb(72,72,72); background-repeat: no-repeat; background-position: top center; }");
        toolbar->addWidget(header);
        toolbar->setMinimumSize(170, 170);
