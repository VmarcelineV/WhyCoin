...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if (fDebug && GetBoolArg("-printcreation"))
        printf("GetProofOfWorkReward() : create=%s nSubsidy=%"PRIu64"\n", FormatMoney(nSubsidy).c_str(), nSubsidy);
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "WhyCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "In 1890, comedian Groucho Marx was born Julius Marx in New York.";
        CTransaction txNew;
        txNew.nTime = 1443795802;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1443795802;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1757580 : 0;

        //// Debug print
        assert(block.hashMerkleRoot == uint256("0xaabb3e48638c91e4b782d0da2680eb19b4bd88f837b1e2bf3a8c4201cc54ae46"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xa1, 0xb2, 0xd7, 0x01 };
